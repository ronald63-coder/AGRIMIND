...
html,body{background:#0a0f0a;font-family:'Inter',sans-serif;color:#e2ffe2}
...
const NAV = [
  { section:"OVERVIEW", items:[
    { id:"overview",  icon:"🖥",  label:"Machine Overview" },
    { id:"intel",     icon:"📡", label:"Intelligence Feed" },
    ...
    <div style={{ background: T.card, border: "1px solid " + T.border,
      ...
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: 11, color: T.muted, marginBottom: 4,
          fontFamily: "'JetBrains Mono'", letterSpacing: "0.06em" }}>{label}</div>
        <div style={{ fontFamily: "'Inter'", fontWeight: 800,
          fontSize: 26, color: T.text, lineHeight: 1, marginBottom: 5 }}>{value}</div>
        {delta && (
      ...
      <div style={{ display: "flex", justifyContent: "space-between",
        ...
        <div>
          <div style={{ fontFamily: "'Inter'", fontWeight: 600,
            fontSize: 14, color: T.text }}>Risk Heat Map</div>
  ...
  return (
    <div style={{ background: T.card, border: "1px solid " + T.border,
      ...
      <div style={{ display: "flex", justifyContent: "space-between",
        alignItems: "center", marginBottom: 12 }}>
        <div style={{ fontFamily: "'Inter'", fontWeight: 600,
          fontSize: 14, color: T.text }}>Intelligence Feed</div>
  ...
  return (
    <div style={{ background: T.card, border: "1px solid " + T.border,
      ...
      <div style={{ display: "flex", justifyContent: "space-between",
        alignItems: "center", marginBottom: 12 }}>
        <div style={{ fontFamily: "'Inter'", fontWeight: 600,
          fontSize: 14, color: T.text }}>System Architecture Status</div>
        <span style={{ fontSize: 10, color: T.g,
  ...
  return (
    <div style={{ background: T.card, border: "1px solid " + T.border,
      ...
      <div style={{ display: "flex", justifyContent: "space-between",
        ...
        <div style={{ fontFamily: "'Inter'", fontWeight: 600,
          fontSize: 14, color: T.text }}>AI Agents Status</div>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <LiveDot color={T.g} />
  ...
  return (
    <div style={{ background: T.card, border: "1px solid " + T.border,
      ...
      <div style={{ display: "flex", justifyContent: "space-between",
        alignItems: "center", marginBottom: 14 }}>
        <div style={{ fontFamily: "'Inter'", fontWeight: 600,
          fontSize: 14, color: T.text }}>Data Streams (Live)</div>
        <button style={{ background: "none", border: "none", color: T.g,
  ...
  return (
    <div style={{ background: T.card, border: "1px solid " + T.border,
      ...
      <div style={{ display: "flex", justifyContent: "space-between",
        alignItems: "center", marginBottom: 14 }}>
        <div style={{ fontFamily: "'Inter'", fontWeight: 600,
          fontSize: 14, color: T.text }}>Predictions Summary</div>
  ...
  return (
    <div style={{ background: T.card, border: "1px solid " + T.border,
      ...
      <div style={{ display: "flex", justifyContent: "space-between",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <div style={{ fontFamily: "'Inter'", fontWeight: 600,
            fontSize: 14, color: T.text }}>Recent Alerts</div>
    ...
    <div style={{ height: 56, background: T.s1,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <span style={{ fontFamily: "'JetBrains Mono'",
          fontSize: 12, color: T.mutedL }}>{timeStr}</span>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8,
          ...
          <div style={{ width: 28, height: 28, borderRadius: "50%",
            background: T.g + "22", display: "flex",
            alignItems: "center", justifyContent: "center",
            fontSize: 14 }}>👤</div>
          <div>
...
export default function MachineDashboard({ onSwitchFarmer }) {
  ...
  const pages = {
    ...
    knowledge:  <LayerPage title="Knowledge Graph" desc="Relationship intelligence across all farm entities"><div style={{background:T.card,border:"1px solid "+T.border,borderRadius:12,padding:24,textAlign:"center",color:T.muted,fontSize:13}}>Knowledge Graph visualization — connect this to Layer 4 component</div></LayerPage>,
    ...
    users:      <LayerPage title="Users & Roles" desc="Platform user management"><div style={{background:T.card,border:"1px solid "+T.border,borderRadius:12,padding:24,color:T.muted,fontSize:13}}>User management panel</div></LayerPage>,
    integrations:<LayerPage title="Integrations" desc="Connected APIs and data sources"><DataStreams /></LayerPage>,
    settings:   <LayerPage title="Settings" desc="Platform configuration"><div style={{background:T.card,border:"1px solid "+T.border,borderRadius:12,padding:24,color:T.muted,fontSize:13}}>Settings panel</div></LayerPage>,
